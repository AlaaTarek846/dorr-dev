            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <!-- Start::slide__category -->
                        <li class="slide__category"><span class="category-name">{{ t('sidebar.catalog') }}</span></li>
                        <!-- End::slide__category -->
                        ...
                        <li class="slide">
                            <router-link :to="{ name: 'admin.flags.index' }" class="side-menu__item">
                                ...
                                <span class="side-menu__label">
                                    {{ t('flags.title') }}
                                    <span v-if="flagsStore.total != null" class="badge bg-light text-default ms-2">{{ flagsStore.total }}</span>
                                </span>
                            </router-link>
                        </li>
                        ...
                        <li class="slide">
                            <router-link :to="{ name: 'admin.countries.index' }" class="side-menu__item">
                                ...
                                <span class="side-menu__label">
                                    {{ t('countries.title') }}
                                    <span v-if="countriesStore.total != null" class="badge bg-light text-default ms-2">{{ countriesStore.total }}</span>
                                </span>
                            </router-link>
                        </li>
                        ...
                        <li class="slide">
                            <router-link :to="{ name: 'admin.currencies.index' }" class="side-menu__item">
                                ...
                                <span class="side-menu__label">
                                    {{ t('currencies.title') }}
                                    <span v-if="currenciesStore.total != null" class="badge bg-light text-default ms-2">{{ currenciesStore.total }}</span>
                                </span>
                            </router-link>
                        </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="/admin/dashboard" class="side-menu__item">CRM</a>
                                </li>
                                <li class="slide">
...
async function fetchSidebarCount(uri, store) {
    if (store.total != null) {
        return;
    }

    try {
        const { data } = await adminAxios.get(uri, {
            params: { paginate: 1, page: 1 },
        });

        if (data.pagination?.total != null) {
            store.setCounts({ total: data.pagination.total });
        }
    } catch {
        //
    }
...
onMounted(async () => {
    await Promise.allSettled([
        fetchSidebarCount('/api/admin/v1/flags', flagsStore),
        fetchSidebarCount('/api/admin/v1/countries', countriesStore),
        fetchSidebarCount('/api/admin/v1/currencies', currenciesStore),
        fetchSidebarCount('/api/admin/v1/languages', languagesStore),
    ]);
});
</script>
