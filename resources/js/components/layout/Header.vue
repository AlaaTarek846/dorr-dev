            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element header-theme-mode">
                        ...
                        <a href="javascript:void(0);" class="header-link layout-setting header-theme-toggle" @click.prevent="toggleTheme">
                    ...
                    <div class="header-element cart-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            ...
                            <span class="badge bg-primary rounded-pill header-icon-badge" id="cart-icon-badge">{{ cartCount }}</span>
                        </a>
                    ...
                    <div class="header-element header-fullscreen">
                        <!-- Start::header-link -->
                        <a href="javascript:void(0);" class="header-link" @click.prevent="toggleFullscreen">
