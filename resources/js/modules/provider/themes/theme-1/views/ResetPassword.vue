<template>
    <div>
        ...
        <form @submit.prevent="submit">
            <div class="row gy-3">
                <div class="col-xl-12 mt-0">
                    <AuthFormInput
                        input-id="provider-reset-password"
                ...
                <div class="col-xl-12">
                    <AuthFormInput
                        input-id="provider-reset-password-confirmation"
        ...
        <div class="text-center mt-4">
            <router-link :to="{ name: 'provider.login' }" class="text-primary">
...
async function submit() {
    ...
    try {
        const { data } = await providerAxios.post('/api/provider/v1/reset-password', {
